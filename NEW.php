...
ini_set('display_startup_errors', 1);*/
 ...
 <head>
 	...
 	<link rel="stylesheet" href="/knowledge_base/css/winter/style_dev.css">
...
<? /* $APPLICATION->IncludeComponent("bitrix:fileman.light_editor","",Array(
    ...
    <header>
    	<div class="header" align="left">
    		...
    		<div class="chat"><br><br>
    			<h1 class="white">База Знаний ЦОВ и ОК</h1>
					<br>
						<div align="center"> 
							<a href="javascript:window.location.reload()"><img src="img/avilon.png" width="200" height="35"> </a> 
						</div>
...
<div class="container">
		<div class="switch white">
			<input type="radio" name="switch" id="switch-off" onclick="document.location='../knowledge_base/index.php';">
				<input type="radio" name="switch" id="switch-on" onclick="document.location='../knowledge_base/index.php?url=new';" checked>
					<div class="name">
						Новогодний режим
					</div>
